...
const shareCodes = [
  {
    zd: $.getdata("zd_shareCode1") || "lgus6d5jyhrin2vz7wwxcayfme",
    nc: $.getdata("nc_shareCode1") || "ba12775ed72a47909d3b1f844cb25234",
    mc: $.getdata("mc_shareCode1") || "MTAxODc2NTE0NzAwMDAwMDAyOTI4OTIyMw==",
    ddgc: $.getdata("dd_shareCode1") || "T0157KwtFEddqQ2RdVkCjVWnYaS5kRrbA",
  ...
  },
  {
    ...
    nc: $.getdata("nc_shareCode2") || "c73e064dcdb547f6bd68abd747767d40",
    mc: $.getdata("mc_shareCode2") || "MTE1NDQ5OTIwMDAwMDAwNDMyNTIxNzc=",
    ddgc: $.getdata("dd_shareCode2") || "T0205KkcA3pEnCCPQmWi4K9cCjVWnYaS5kRrbA",
